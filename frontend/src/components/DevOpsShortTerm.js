      ...
      <section className="product-hero" style={{
        ...
        <div className="container">
          ...
          <p style={{ fontSize: '20px', opacity: '0.9', maxWidth: '800px', margin: '0 auto' }}>
            Accelerate your DevOps career with our intensive 4-month program featuring cloud technologies and automation
          </p>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '30px' }}>
            ...
            <div className="feature-card" style={{
              ...
              <p style={{ color: '#666', lineHeight: '1.6' }}>
                Live sessions on cutting-edge DevOps practices, CI/CD pipelines, Kubernetes, 
                cloud infrastructure, and automation tools. Learn how to bridge the gap between development and operations.
              </p>
            </div>
        ...
        <div className="container">
          ...
          <div style={{
            ...
            <p style={{ marginBottom: '20px' }}>
              ...
              in this rapidly growing field through a comprehensive 4-month program designed to turn you into a job-ready DevOps expert.
            </p>
            <p>
      ...
      <section className="industry-stats" style={{ padding: '80px 0' }}>
        <div className="container">
          ...
          <div style={{
            ...
            <p>
              Simultaneously, the cloud computing market is set to surge from USD 626.4 billion in 2024 to over 
              USD 1.5 trillion by 2029, with a CAGR of 19.3%. These trends underscore the rapid expansion 
              and immense career potential in this dynamic field.
            </p>
          </div>
