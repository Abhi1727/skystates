          ...
          <div style={{
            ...
            >
              ...
              <p style={{ 
                ...
                Master ethical hacking, network security & cyber <span style={{ color: '#3b82f6', fontWeight: '700' }}>professional</span> skill development
              </p>
              ...
              <div style={{
                ...
                {[
                  { icon: '⚡', text: '2x Faster Threat Detection', color: '#3b82f6' },
                  { icon: '🛡️', text: 'Security-First Skills', color: '#60a5fa' },
                  { icon: '�', text: 'Ethical Hacking Mastery', color: '#2563eb' },
                  { icon: '🎯', text: 'Defense Expert', color: '#1e40af' }
                ].map((item, index) => (
                  <motion.div
                    key={index}
                    style={{
